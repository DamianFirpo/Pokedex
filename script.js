...
$soundPowerBtn = d.querySelector(".text-playing"),
    ...
    async function getDataPokemon () {
        ...
        try{
            ...
            try {
                ...
                "<p>Algunos pokémones son tan dificiles de encontrar, que no se tiene informacion acerca de ellos.. con suerte podemos encontrar alguna imagen que los represente</p>"
        }
    ...
    d.addEventListener("click", (e) => {
        ...
        if (!$powerBtn.classList.contains("is-off")) {
            if (e.target ===  $btnStartSearch) {
                ...
                ? getDataPokemon()
                : alert (
                    "Debe ingresar el numero o nombre del pokemon que desea buscar"
                );
            }
